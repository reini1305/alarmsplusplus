...
static void window_load(Window* window) {
  ...
  text_layer_set_text(s_layer_text, "This app has been developed by Christian Reinbacher\n\nHint: long-press middle button to toggle alarm");
...
static void layer_header_update(Layer* layer, GContext* ctx) {
  ...
  graphics_draw_text(ctx, "Alarms++ v1.10", fonts_get_system_font(FONT_KEY_GOTHIC_18_BOLD), GRect(0, -2, 144, 24), GTextOverflowModeFill, GTextAlignmentCenter, 0);
}